...
# gnome-terminal -- bash -c "ros2 run rviz2 rviz2 --ros-args -p use_sim_time:=true -d /home/daniel/projects/foodlikeair/2wd_robot/src/yardguard_description/rviz/map_loaded.rviz"

gnome-terminal -- bash -c "ros2 run rviz2 rviz2 use_sim_time:=true -d /home/daniel/projects/foodlikeair/2wd_robot/src/yardguard_description/rviz/map_loaded.rviz"

# sleep 2
# gnome-terminal -- bash -c "ros2 launch slam_toolbox online_async_launch.py use_sim_time:=True" map_file:=/home/daniel/projects/foodlikeair/2wd_robot/maps/test_map/map.yaml
