...
#                 [FindPackageShare("yardguard_description"), "urdf", "output", "yardguard.urdf"]
#             ),
# #            " ",
# #            "use_mock_hardware:=",
# #            use_mock_hardware,
...
#     )
    ...
    urdf_path = os.path.join(get_package_share_directory('yardguard_description'), 'urdf', "output", 'yardguard.urdf')
    ...
    robot_controllers = PathJoinSubstitution(
        [
            FindPackageShare("yardguard_bringup"),
            "config",
